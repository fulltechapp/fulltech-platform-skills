...
- `plugins/linux-sanitizer`: Bash triage/remediation for Ubuntu/Debian with automatic WSL mode (`wsl.conf`, Windows PATH, generated hosts). Host-side WSL (vhdx compaction, `.wslconfig`) lives in `windows-sanitizer`.
